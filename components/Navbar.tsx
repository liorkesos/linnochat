    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/80 dark:bg-dark-900/80 backdrop-blur-md border-b border-gray-200 dark:border-white/5' : 'bg-transparent'}`}>
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="https://linno.chat" className="px-4 py-2 rounded-full bg-dark-900 dark:bg-white text-white dark:text-dark-900 text-sm font-bold hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors shadow-md">
            Login
          </a>
        </div>
      </div>
